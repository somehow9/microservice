...
# server.config["MONGO_URI"] = "mongodb://192.168.1.157:27017/videos"
mongo_video = PyMongo(server,uri="mongodb://192.168.1.157:27017/videos")
mongo_mp3 = PyMongo(server,uri="mongodb://192.168.1.157:27017/mp3s")
...
def upload():
    ...
    if access["admin"]:
        if len(request.files) > 1 or len(request.files) < 1:
            return "exactly 1 file requied",400
